...
import { Lock, Mail, Eye, EyeOff, Loader2, ArrowRight, Zap, CheckCircle2 } from 'lucide-react';
         ...
         <div className="relative z-10 flex flex-col justify-between p-16 w-full text-white">
            ...
            <div className="space-y-8 max-w-lg">
                <h1 className="text-5xl font-black leading-tight tracking-tight">
                    O Sistema <br/> 
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">Operacional do Provedor</span>
                </h1>
                
                <div className="space-y-4">
                    <div className="flex items-start gap-4">
                        <div className="p-2 bg-blue-500/10 rounded-lg text-blue-400 mt-1"><CheckCircle2 size={20} /></div>
                        <div>
                            <h3 className="font-bold text-lg text-white">Centralize seu Atendimento</h3>
                            <p className="text-slate-400 text-sm">WhatsApp, Instagram e Webchat em uma única tela.</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        <div className="p-2 bg-emerald-500/10 rounded-lg text-emerald-400 mt-1"><Zap size={20} /></div>
                        <div>
                            <h3 className="font-bold text-lg text-white">Automação Inteligente</h3>
                            <p className="text-slate-400 text-sm">Chatbots que consultam faturas e desbloqueiam clientes 24/7.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex justify-between items-end border-t border-white/10 pt-8">
                <div className="text-xs font-medium text-slate-400">
                    © 2025 NexZap Tecnologia.<br/>Feito para Provedores.
                </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
         <div className="w-full max-w-md space-y-8 animate-in slide-in-from-right-10 fade-in duration-500">
            ...
            <div className="text-center lg:text-left">
                ...
                <h2 className="text-3xl font-black text-white tracking-tight">Acesse sua conta</h2>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
                <div className="space-y-1.5">
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-wider pl-1">Email Corporativo</label>
                ...
                <div className="space-y-1.5">
                    <div className="flex justify-between items-center pl-1 pr-1">
                        ...
                        <a href="#" className="text-xs font-bold text-blue-500 hover:text-blue-400">Esqueceu?</a>
                    </div>
                    <div className="relative group">
