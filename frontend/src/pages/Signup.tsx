...
import { Lock, Mail, Eye, EyeOff, Loader2, User, Building2, Phone, CheckCircle, Zap } from 'lucide-react';
            ...
            <div className="space-y-8 max-w-lg">
                ...
                <ul className="space-y-4">
                    <li className="flex items-center gap-3 text-lg font-medium text-emerald-100">
                        <CheckCircle className="text-emerald-400" /> Integração IXC / Voalle / MK
                    </li>
                    <li className="flex items-center gap-3 text-lg font-medium text-emerald-100">
                        <CheckCircle className="text-emerald-400" /> App Exclusivo para Técnicos
                    </li>
                    <li className="flex items-center gap-3 text-lg font-medium text-emerald-100">
                        <CheckCircle className="text-emerald-400" /> IA que resolve problemas de rede
                    </li>
                </ul>
            </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative overflow-y-auto custom-scrollbar">
         <div className="w-full max-w-md space-y-6 animate-in slide-in-from-right-10 fade-in duration-500">
            ...
            <div className="text-center lg:text-left mb-8">
                ...
                <h2 className="text-3xl font-black text-white tracking-tight">Cadastro de Provedor</h2>
                <p className="mt-2 text-slate-400">Configure seu ambiente em menos de 2 minutos.</p>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider pl-1">Seu Nome</label>
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider pl-1">Celular/Whatsapp</label>
                        <div className="relative group">
                ...
                <div className="space-y-1.5">
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-wider pl-1">Nome do Provedor</label>
                    <div className="relative group">
                        <Building2 className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-emerald-500 transition-colors" size={18} />
                        <input 
                            type="text" 
                            required
                            className="w-full bg-slate-900 border border-slate-800 focus:border-emerald-500 rounded-xl py-3 pl-10 pr-4 text-slate-200 outline-none transition-all font-medium text-sm"
                ...
                <div className="space-y-1.5">
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-wider pl-1">Email de Acesso</label>
                    <div className="relative group">
                ...
                <div className="space-y-1.5">
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-wider pl-1">Senha</label>
                    <div className="relative group">
